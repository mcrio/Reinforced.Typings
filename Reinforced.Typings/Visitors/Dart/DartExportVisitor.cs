...
{
    public partial class DartExportVisitor : TextExportingVisitor
    {
        ...
        public DartExportVisitor(TextWriter writer, ExportContext exportContext) : base(writer, exportContext)
        {
